 (function(){
  var Surface=function(node){
    ...
    this.setTurtable=function(yaw, pitch){
      ...
      this.setTurtable(3.141,3.141/2);  // from above, flat
      //this.setTurtable(0.5,0.5);// at an angle
      //this.setTurtable(0,0);  // from above, flat
...
function drawHeadings(){
    svg.append("svg")
         ...
         .attr("x", 20 )
         .attr("y", 40)
         .attr("stroke","Blue").style("font-size","20px")
        .text("Drag to change view");
    svgstatic.append("svg")
         .append("text")
        // .attr("x", 200)
        // .attr("y", 100)
